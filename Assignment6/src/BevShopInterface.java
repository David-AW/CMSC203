...
public interface BevShopInterface {
	...
	/**
	 * returns constant maximum number of alcohol beverages/per order offered by the
	 * beverage shop
	 *
	 * @return constant maximum number of alcohol beverages/per order offered by the
	 *         beverage shop
	 */
	...
	/**
	 * returns the current Order located in the index in the list of orders. Notes:
